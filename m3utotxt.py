       ...
       #  },
        {
            ...
            "default_group": "成人直播_9",         # 没有group-title= 分组名称添加分组名称
            "rename_groups": {"XXX": "成人点播_9"},   # 替换分组名称
            "rename_channel1": {"MyCamTV ": ""},     # 替换频道名称1
            "rename_channel2": {"AdultIPTV.net ": ""},    # 替换频道名称2
        },
        # 可以添加更多的链接，并在URL中指定自定义频道分组名称、替换分组名称、替换频道名称（2个）
    ]
